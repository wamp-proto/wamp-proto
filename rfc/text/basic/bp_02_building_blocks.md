...
* IDs in the *session scope* MUST be incremented by 1 beginning with 1 (for each direction - *Client-to-Router* and *Router-to-Client*). An exception to this rule is for the *Progressive Calls* advanced feature (see relevant subsection under *Advanced RPC*).
